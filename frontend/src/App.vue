...
<template>
  ...
  >
    <div class="max-w-md mx-auto flex justify-around items-center h-16 pt-1">
      ...
      <router-link 
        to="/settings" 
        class="flex flex-col items-center justify-center w-20 h-full text-slate-400 hover:text-brand transition-colors"
      ...
      >
        ...
        <span class="text-[0.65rem] uppercase tracking-wider">Impostazioni</span>
      </router-link>

      <!-- Bottone Dashboard (Diario) -->
      <router-link 
        to="/" 
        class="flex flex-col items-center justify-center w-20 h-full text-slate-400 hover:text-brand transition-colors"
        active-class="text-brand font-semibold"
      >
        ...
        <span class="text-[0.65rem] uppercase tracking-wider">Diario</span>
      </router-link>
      ...
      <router-link 
        ...
        active-class="text-brand font-semibold"
      >
        <svg class="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 012-2h2a2 2 0 012 2v62 2 0 01-2 2h-2a2 2 0 01-2-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
        <span class="text-[0.65rem] uppercase tracking-wider">Statistiche</span>
      </router-link>
